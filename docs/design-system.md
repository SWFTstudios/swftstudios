...
| `--swft-h6` / `h6` | `1rem` | `1.4` | |
| `--swft-text-body` / `body` | `1rem` (16px) | `1.5` | Color: `--swft-text` |
| `--swft-text-lead` | `clamp(1rem … 1.125rem)` | `1.55` | Color: `--swft-lead` |
| `--swft-text-small` | `0.875rem` | `1.5` | |
| `--swft-text-tiny` | `0.75rem` | `1.4` | Eyebrows / labels |
